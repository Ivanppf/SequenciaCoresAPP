...
import com.student.jogosequenciadecores.databinding.LayoutJogoBinding
import com.student.jogosequenciadecores.databinding.LayoutRespostaBinding
import com.student.jogosequenciadecores.viewModel.CriadorShape
...
class TelaJogo : AppCompatActivity(), View.OnTouchListener {
    ...
    private lateinit var binding: LayoutJogoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = LayoutJogoBinding.inflate(layoutInflater)
    ...
    override fun onBackPressed() {
        ...
        i.putExtra("tela", "com.student.jogosequenciadecores.view.MenuInicial")
        startActivity(i)
